...
s.source       = { :git => "https://github.com/864764448/FC_AlipaySDK.git", :tag => "0.1.0" }
...
s.resources = "FC_AlipaySDK/AlipaySDK.bundle"
...
s.frameworks  = "Foundation","CoreTelephony","SystemConfiguration","CoreMotion"
