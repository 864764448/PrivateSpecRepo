#
#  Be sure to run `pod spec lint FC_MJPhotoBrowser.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/864764448/FC_MJPhotoBrowser"
  ...
  s.source_files  = "FC_MJPhotoBrowser/*.{h,m}"
